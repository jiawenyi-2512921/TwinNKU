...
> 后续显示修正：用户要求恢复原图内文字，已取消本文早期方案中的固定14px名称、白底标签、分层避让与名称开关。最新行为及代码更新见[14-restore-map-lettering.md](14-restore-map-lettering.md)。本文地图v3/楼层v2资源、83点数据、校验值及导入命令继续有效；资源包无需重新下载或更换。
