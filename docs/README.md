...
2026-09-26管理工作台升级：统一点位/楼层/VR审核中心、全局资料搜索、真实待办统计、变更对照与读取恢复，见[37](37-admin-workbench.md)。需同时更新API与web，无新增数据库迁移；旧待审资源自动进入统一查询。

2026-09-26下午用户要求暂停智能体接入并持续推进其他功能；收藏、最近浏览、搜索、浏览历史恢复、公共资料超时及原图加载恢复见[36持续开发记录](36-continuous-development.md)。第三批同时完善[17只读资源验收报告](17-floor-release.md)；不重导地图或更改审核数据。
