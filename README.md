...
**给部署方：**本轮使用[最新资源发布页](https://github.com/jiawenyi-2512921/TwinNKU/releases/tag/map-interactions-2026.09.23-v3)，按[更新步骤](docs/13-map-interaction-update.md)下载、校验、导入地图v3与图书馆标注楼层v2。代码从PR #3当前分支取得，勿使用旧资源包替代。
...
当前交付 **地图交互与标注楼层查看**：保留原点位ID，83个命名地点可点击；无未命名点击区域；新增两座业务楼正中央的周恩来雕像。移除排序序号，地图名称固定字号并随缩放分层、自动避让。楼层提供缩放、拖动、原尺寸、大图和分享，只显示有标注图。
...
校园底图仍为8279×5604，revision 3的265张图块与旧版逐字节一致；名称与雕像标记使用独立交互层。导入与验收见[当前交付说明](docs/13-map-interaction-update.md)。
