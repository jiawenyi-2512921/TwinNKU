...
**给部署方：**地图和楼层图片已通过[GitHub资源发布页](https://github.com/jiawenyi-2512921/TwinNKU/releases/tag/resources-2026.09.23-v1)交付。按[资源下载与导入步骤](docs/12-github-resource-handoff.md)直接在服务器下载、校验、导入，无需用户手动转传文件。
